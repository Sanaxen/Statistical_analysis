...
#pragma omp parallel for
			...
			double w_tmp = sqrt(best_independ*best_independ + best_residual* best_residual);
			...
			double value = (1.0 - rt)*fabs(weight1*residual - weight2*independ) + weight1*residual + weight2*independ;
