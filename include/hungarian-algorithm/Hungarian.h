...
// 
///////////////////////////////////////////////////////////////////////
// I changed the I / F and converted it into a single header
// by Sanaxn
...
public:
	...
	double Solve(Matrix<dnn_double>& DistMatrix, vector<int>& Assignment)
	{
		unsigned int nRows = DistMatrix.m;
		unsigned int nCols = DistMatrix.n;
