...
train -s 0  -B 5 Breast-Cancer-Wisconsin-Diagnostic.csv_libsvm.format model


predict -b 1 Breast-Cancer-Wisconsin-Diagnostic.csv_libsvm.format model output.txt
