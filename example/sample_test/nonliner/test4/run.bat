...
--epochs 26000 --n_layers 16  --n_rnn_layers 1  --normal minmax  --rnn_type lstm --use_cnn 2 ^
--seq_len 34 --minibatch_size 34 --hidden_size 200 --test_mode 0 --early_stopping 1 --test_mode 0 --support 0
