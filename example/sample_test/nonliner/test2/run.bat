...
%LDM%\TimeSeriesRegression.exe  --x 2 --y 3 --csv sample.csv --test 0.5 --progress %progress% --plot 5 --tol 0.01 --epochs 600 --n_layers 5 --seq_len 64 --input_unit 32 --minibatch_size 64 --ref_prev 15
